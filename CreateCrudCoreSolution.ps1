...
function Write-Business-IoC {
    ...
    $Ns = Get-Qualified-Namespace -LocalNameSpace ($SolutionName + 'Business.Services')
    ...
    Push-And-Ensure 'Services'
        ...
        $ViewControllerNs = Get-Qualified-Namespace -LocalNameSpace ($SolutionName + '.Business.ViewController')
    ...
    Push-And-Ensure -Name $SolutionName
        ...
        Push-And-Ensure -Name 'src'
            ...
            if ($Business)
            {
                ...
                Add-Project-And-Push-Location -Name $WebApiClientProjDir -Type 'classlib' -Specification -Injection -Configuration
